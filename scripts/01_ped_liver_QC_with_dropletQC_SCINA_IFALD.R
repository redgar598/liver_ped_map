...
save(SCINA_cell_labels, file=here("../../../projects/macparland/RE/PediatricAdult/processed_data","IFALD_adult_ped_SCINA_cell_labels.RData"))
...
# 
# 
# # ## donor integrated map, clusters needing checks: 13, 14, 17, 21, 25, 26, 28, 31
...
# 
# 
# DimPlot(d10x.combined, reduction = "umap")+scale_color_manual(values=c(rep("grey",13),"red",rep("grey", 19)))
# 
# 
# 
# #############
...
#                                                      "C104_bx5pr Ped","C102 Ped","C105_caud5pr Ped",
...
# 
# ## one unclear cluster
# cluster4.markers <-  FindMarkers(d10x.combined_myeloid, ident.1 = 6, min.pct = 0.25)
# head(cluster4.markers, n = 10)
# head(cluster4.markers[which(cluster4.markers$avg_log2FC>0),], n = 20)
# FeaturePlot(d10x.combined_myeloid, features = c("PPBP","NRGN"), min.cutoff = "q9", pt.size=1)
# 
# cluster4.markers <-  FindMarkers(d10x.combined_myeloid, ident.1 = 8, min.pct = 0.25)
# head(cluster4.markers, n = 10)
# head(cluster4.markers[which(cluster4.markers$avg_log2FC>0),], n = 20)
...
# d10x.combined_myeloid@meta.data$CellType_rough[which(d10x.combined_myeloid@meta.data$seurat_clusters%in%c("2","4"))]<-"KC Like"
# d10x.combined_myeloid@meta.data$CellType_rough[which(d10x.combined_myeloid@meta.data$seurat_clusters%in%c("5"))]<-"Neutrophil"
# d10x.combined_myeloid@meta.data$CellType_rough[which(d10x.combined_myeloid@meta.data$seurat_clusters%in%c("6"))]<-"Platelet"
# d10x.combined_myeloid@meta.data$CellType_rough[which(d10x.combined_myeloid@meta.data$seurat_clusters%in%c("7"))]<-"Doublet"
# d10x.combined_myeloid@meta.data$CellType_rough[which(d10x.combined_myeloid@meta.data$seurat_clusters%in%c("1","3"))]<-"Macrophage (MHCII high)"
# d10x.combined_myeloid@meta.data$CellType_rough[which(d10x.combined_myeloid@meta.data$seurat_clusters%in%c("8"))]<-"Macrophage (CLEC9A high)"
# 
# DefaultAssay(d10x.combined_myeloid) <- "RNA"
...
# cluster4.markers <-  FindMarkers(d10x.combined_bcell, ident.1 = 8, min.pct = 0.25)
# head(cluster4.markers, n = 10)
...
# d10x.combined_bcell@meta.data$CellType_rough[which(d10x.combined_bcell@meta.data$seurat_clusters%in%c("0","7","8","9"))]<-"Mature B-cells"
# d10x.combined_bcell@meta.data$CellType_rough[which(d10x.combined_bcell@meta.data$seurat_clusters%in%c("2","6"))]<-"Plasma cells"
# d10x.combined_bcell@meta.data$CellType_rough[which(d10x.combined_bcell@meta.data$seurat_clusters%in%c("3","5"))]<-"Cycling T-cells"
# d10x.combined_bcell@meta.data$CellType_rough[which(d10x.combined_bcell@meta.data$seurat_clusters%in%c("4"))]<-"Cycling Myeloid"
# d10x.combined_bcell@meta.data$CellType_rough[which(d10x.combined_bcell@meta.data$seurat_clusters%in%c("1"))]<-"Cycling B-cells"
# 
...
# 
# ## one unclear cluster
# cluster4.markers <-  FindMarkers(d10x.combined_NK_T, ident.1 = 6, min.pct = 0.25)
# head(cluster4.markers, n = 20)
# FeaturePlot(d10x.combined_NK_T, reduction = "umap", features = c("FCER1G","CLNK","IL2RB"), ncol = 2)
# cluster4.markers <-  FindMarkers(d10x.combined_NK_T, ident.1 = 9, min.pct = 0.25)
# head(cluster4.markers, n = 20)
...
# d10x.combined_NK_T@meta.data$CellType_rough[which(d10x.combined_NK_T@meta.data$seurat_clusters%in%c("1","2","4","5"))]<-"CD3+ T-cells"
# d10x.combined_NK_T@meta.data$CellType_rough[which(d10x.combined_NK_T@meta.data$seurat_clusters%in%c("3","7"))]<-"gd T-cells"
# d10x.combined_NK_T@meta.data$CellType_rough[which(d10x.combined_NK_T@meta.data$seurat_clusters%in%c("8","9"))]<-"Doublet"
# d10x.combined_NK_T@meta.data$CellType_rough[which(d10x.combined_NK_T@meta.data$seurat_clusters%in%c("6"))]<-"CLNK T-cells"
# 
# 
# 
