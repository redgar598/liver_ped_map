...
# save_plts(individual_split, "IFALD_individual_roughCell_facet_rPCA_UMAP", w=22,h=14)
# 
...
# save_plts(all_refined_cluster_umap, "IFALD_refined_cellType_map", w=7,h=5)
# 
# 
...
# save_plts(all_refined_cluster_umap_nolab, "IFALD_refined_cellType_map_nolabel", w=7,h=5)
# 
...
# save_plts(individual_split, "IFALD_individual_roughCell_facet_rPCA_UMAP_refined", w=22,h=12)
# 
# cell_num_all<-as.data.frame(table(d10x.combined@meta.data$AgeGroup))
# colnames(cell_num_all)<-c("AgeGroup","CellCount")
...
# save_plts(age_split, "IFALD_age_roughCell_facet_rPCA_UMAP_refined", w=10,h=5)
# 
# 
# ##############
# ### entropy in clusters
