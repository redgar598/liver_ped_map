...
# 
# 
# Mmt1<-plot_grid(plot_grid(plot_grid(fanciest_UMAP,nice_legend, rel_widths = c(5,2)),umap_expression, ncol=2,  align = "hv", axis="lr"), violin_plt, ncol=1, rel_heights = c(1,0.8))
# ggsave(Mmt1, file=here("figures/MTM1_liver_human_fetal_scRNAseq.jpeg"), w=12, h=10)
# 
# 
