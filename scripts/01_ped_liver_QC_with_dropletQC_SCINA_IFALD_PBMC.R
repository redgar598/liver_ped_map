...
load(file = here("../../../projects/macparland/RE/PediatricAdult/processed_data","IFALD_d10x_adult_ped_raw_PBMC.rds"))
...
save_plts(chem_umap_sct, "IFALD_chem_SCT_umap_PBMC", w=6,h=4)

age_umap_sct<-DimPlot(d10x, reduction = "umap", group.by = "AgeGroup", pt.size=0.25)+fillscale_age
save_plts(age_umap_sct, "IFALD_age_SCT_umap_PBMC", w=6,h=4)

individual_umap_sct<-DimPlot(d10x, reduction = "umap", group.by = "individual", pt.size=1)
save_plts(individual_umap_sct, "IFALD_individual_SCT_UMAP_PBMC", w=6,h=4)
