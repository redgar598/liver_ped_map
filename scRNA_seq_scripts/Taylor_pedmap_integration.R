...
taylor_mat_loc <- here("/home/redgar/Documents/liver_ped_map/data/Taylor_GSE163650")
...
saveRDS(d10x.combined, file = here("../../../projects/macparland/RE/PediatricAdult/BA_GSE176189","BA_d10x_adult_ped_integrated.rds"))
